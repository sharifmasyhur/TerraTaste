...
function showEnvironmentAverageText(){
  ...
  annualCF + "kg of Carbon is " + national_metric + " the worldwide per capita average of 4.8 tons of carbon emissions every year<sup>2</sup> "
  + needed_metric + " the 680kg maximum upper limit of a sustainable diet necessary to prevent climate catastrophe.<sup>3</sup>";
}
